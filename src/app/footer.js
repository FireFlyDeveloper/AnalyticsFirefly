                ...
                <div className="grid md:grid-cols-4 gap-8">
                    <div className="md:col-span-2">
                        ...
                        <p className="text-gray-300 text-sm leading-relaxed max-w-md">
                            ...
                            Upload, analyze, and generate professional reports in minutes.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-gray-300">
                            <li><a href="#" id="termsLink"
                                className="hover:text-white transition-colors duration-300 cursor-pointer">Terms &
                                Conditions</a></li>
                            <li><a href="#" className="hover:text-white transition-colors duration-300">Privacy Policy</a></li>
                            <li><a href="#" className="hover:text-white transition-colors duration-300">Data Security</a></li>
