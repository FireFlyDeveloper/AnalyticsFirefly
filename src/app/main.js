                ...
                <div className="glass-effect rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 card-shadow relative overflow-hidden">
                    ...
                    <div className="text-center relative z-10">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto text-sm sm:text-base md:text-lg leading-relaxed">
                            Upload your Excel files and let our advanced AI analyze your data to generate comprehensive reports with actionable insights and beautiful visualizations.
                        </p>
                ...
                <div className="lg:col-span-2">
                    <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 card-shadow relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <div id="uploadArea" className="upload-area rounded-lg sm:rounded-xl p-4 sm:p-6 md:p-8 lg:p-12 text-center cursor-pointer relative overflow-hidden">
                                ...
                                <div id="uploadContent" className="relative z-10">
                                    ...
                                    <h4 className="text-lg sm:text-xl font-semibold text-gray-700 mb-2 sm:mb-3">Drop your Excel files here</h4>
                                    <p className="text-gray-500 mb-4 sm:mb-6 max-w-md mx-auto text-sm sm:text-base">
                                        Drag and drop your Excel files or click to browse. Our AI will analyze your data and generate comprehensive insights.
                                    </p>
                                    ...
                                    <button id="browseBtn" className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-4 sm:px-6 md:px-8 py-3 sm:py-4 rounded-lg sm:rounded-xl font-medium transition-all duration-300 transform hover:scale-105 hover:shadow-xl shadow-lg w-full sm:w-auto">
                                        <span className="flex items-center justify-center sm:justify-start space-x-2 sm:space-x-3 text-sm sm:text-base">
                                            ...
                                            <span className="text-xs sm:text-sm opacity-75 hidden sm:block">or drag & drop</span>
                                        </span>
                                    </button>
                                </div>
                                ...
                                <div id="uploadProgress" className="hidden relative z-10">
                                    ...
                                    <h4 className="text-lg sm:text-xl font-semibold text-gray-700 mb-3 sm:mb-4">Analyzing your data with AI...</h4>
                                    ...
                                    <p className="text-xs sm:text-sm text-gray-400 mt-3 sm:mt-4">
                                        Our AI is extracting insights from your data. This may take a few moments.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div className="space-y-4 sm:space-y-6">
                    ...
                    <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 card-shadow relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            <div className="flex items-center mb-3 sm:mb-4">
                                ...
                                <h4 className="font-semibold text-gray-800 text-sm sm:text-base">AI Features</h4>
                            </div>
                            <ul className="space-y-3 sm:space-y-4 text-xs sm:text-sm text-gray-600">
                                <li className="flex items-start space-x-2 sm:space-x-3">
                                    ...
                                    <div>
                                        <div className="font-medium text-gray-700 text-xs sm:text-sm">Automated Analysis</div>
                                        <div className="text-gray-500 text-xs">Smart data processing</div>
                                    </div>
                                </li>
                                <li className="flex items-start space-x-2 sm:space-x-3">
                                    <div className="w-4 h-4 sm:w-5 sm:h-5 bg-green-100 rounded-full flex items-center justify-center mt-0.5 flex-shrink-0">
                                    ...
                                    <div>
                                        <div className="font-medium text-gray-700 text-xs sm:text-sm">Pattern Recognition</div>
                                        <div className="text-gray-500 text-xs">Identify hidden trends</div>
                                    </div>
                                </li>
                                <li className="flex items-start space-x-2 sm:space-x-3">
                                    <div className="w-4 h-4 sm:w-5 sm:h-5 bg-green-100 rounded-full flex items-center justify-center mt-0.5 flex-shrink-0">
                                    ...
                                    <div>
                                        <div className="font-medium text-gray-700 text-xs sm:text-sm">Trend Analysis</div>
                                        <div className="text-gray-500 text-xs">Forecast future patterns</div>
                                    </div>
                                </li>
                                <li className="flex items-start space-x-2 sm:space-x-3">
                                    <div className="w-4 h-4 sm:w-5 sm:h-5 bg-green-100 rounded-full flex items-center justify-center mt-0.5 flex-shrink-0">
                                    ...
                                    <div>
                                        <div className="font-medium text-gray-700 text-xs sm:text-sm">Professional Reports</div>
                                        <div className="text-gray-500 text-xs">Export-ready documents</div>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 card-shadow relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            <div className="flex items-center mb-3 sm:mb-4">
                                ...
                                <h4 className="font-semibold text-gray-800 text-sm sm:text-base">Supported Formats</h4>
                            </div>
                            <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm">
                                <div className="flex items-center justify-between p-2 sm:p-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-100">
                                    ...
                                    <span className="text-blue-600 font-semibold bg-blue-100 px-1 sm:px-2 py-0.5 sm:py-1 rounded text-xs">.xlsx</span>
                                </div>
                                <div className="flex items-center justify-between p-2 sm:p-3 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg border border-purple-100">
                                    ...
                                    <span className="text-purple-600 font-semibold bg-purple-100 px-1 sm:px-2 py-0.5 sm:py-1 rounded text-xs">.xls</span>
                                </div>
                            </div>
                    ...
                    <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 card-shadow border border-indigo-100">
                        <div className="flex items-center mb-3 sm:mb-4">
                            ...
                            <h4 className="font-semibold text-gray-800 text-sm sm:text-base">How It Works</h4>
                        </div>
                        <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm">
                            <div className="flex items-center space-x-2 sm:space-x-3">
                                <div className="w-5 h-5 sm:w-6 sm:h-6 bg-indigo-500 text-white rounded-full flex items-center justify-center text-xs font-bold">1</div>
                                <span className="text-gray-600">Upload your Excel file</span>
                            </div>
                            <div className="flex items-center space-x-2 sm:space-x-3">
                                <div className="w-5 h-5 sm:w-6 sm:h-6 bg-purple-500 text-white rounded-full flex items-center justify-center text-xs font-bold">2</div>
                                <span className="text-gray-600">AI analyzes your data</span>
                            </div>
                            <div className="flex items-center space-x-2 sm:space-x-3">
                                <div className="w-5 h-5 sm:w-6 sm:h-6 bg-pink-500 text-white rounded-full flex items-center justify-center text-xs font-bold">3</div>
            ...
            <div id="resultsSection" className="hidden">
                <div className="slide-up">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 sm:mb-6 gap-3">
                        ...
                        <button id="downloadBtn" className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg sm:rounded-xl font-medium transition-all duration-300 transform hover:scale-105 flex items-center space-x-2 pulse-glow w-full sm:w-auto">
                            <span>🖨️</span>
                    ...
                    <div className="document-container">
                        <div className="document-content page-lines">
                            <div id="reportContent" className="prose prose-sm sm:prose-lg max-w-none text-gray-800 leading-relaxed"></div>
                        </div>
                    </div>
                </div>
            </div>
