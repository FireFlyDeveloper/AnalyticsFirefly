    ...
    view === "privacy" ? (
      <>
        ...
        <ul className="text-gray-600 mb-4 space-y-2">
          <li>
            • All file uploads are encrypted in transit using industry
            standards.
          </li>
          <li>• Uploaded files are not stored permanently.</li>
          <li>
            • We maintain technical safeguards to prevent unauthorized access.
          </li>
        </ul>
        <h3 className="text-lg font-semibold text-gray-800 mb-3">
        ...
        <p className="text-gray-600 mb-4">
          Do not upload malicious content, personal data of others without
          consent, or copyrighted material without permission.
        </p>
        <h3 className="text-lg font-semibold text-gray-800 mb-3">
      ...
      <>
        ...
        <p className="text-gray-600 mb-4">
          All data transmitted to and from AnalyticsFirefly is encrypted using
          TLS protocols to ensure confidentiality and integrity.
        </p>
        <h3 className="text-lg font-semibold text-gray-800 mb-3">
          2. Storage & Retention
        </h3>
        <p className="text-gray-600 mb-4">
          Uploaded files are processed securely and are not stored permanently.
          Generated reports are stored only locally unless you choose to save
          them.
        </p>
        <h3 className="text-lg font-semibold text-gray-800 mb-3">
        ...
        <ul className="text-gray-600 mb-4 space-y-2">
          ...
          <li>
            • Access to data is strictly limited to automated processing
            systems.
          </li>
          <li>
            • We implement safeguards to protect against unauthorized access or
            breaches.
          </li>
        </ul>
        <h3 className="text-lg font-semibold text-gray-800 mb-3">
        ...
        <p className="text-gray-600 mb-4">
          Ensure your local devices are secure and do not share your login
      ...
      <>
        ...
        <p className="text-gray-600 mb-4">
          By using AnalyticsFirefly, you agree to abide by these Terms &
          Conditions.
        </p>
        <h3 className="text-lg font-semibold text-gray-800 mb-3">
          2. License to Use
        ...
        <p className="text-gray-600 mb-4">
          AnalyticsFirefly is not liable for indirect, incidental, or
